...
class Platform(XilinxPlatform):
    ...
    def __init__(self, variant="a7-35", toolchain="vivado"):
        ...
        self.add_platform_command("set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ov2640_left_pclk_clk]")
        self.add_platform_command("set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ov2640_left_pclk0]")
        self.add_platform_command("set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets main_ov2640_left_pclk0]")
        self.add_platform_command("set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ov2640_right_pclk_clk]")
        self.add_platform_command("set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets ov2640_right_pclk0]")
        self.add_platform_command("set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets main_ov2640_right_pclk0]")
