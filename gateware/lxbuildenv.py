...
DEFAULT_DEPS = {
    ...
    'nmigen':       'https://github.com/nmigen/nmigen.git',
    'litex':        'https://github.com/antmicro/litex.git',
    'litedram':     'https://github.com/enjoy-digital/litedram.git',
    'litex-boards': 'https://github.com/antmicro/litex-boards.git',
    'liteeth':      'https://github.com/enjoy-digital/liteeth.git',
    'liteiclink':   'https://github.com/enjoy-digital/liteiclink.git',
    'litevideo':    'https://github.com/antmicro/litevideo.git',
